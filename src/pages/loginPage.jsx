                    ...
                    <div className="w-[450px] h-[600px] backdrop-blur-xl shadow-xl rounded-xl flex flex-col justify-center items-center ">
                        ...
                        <input onChange={(e)=>{
                         ...
                         <input onChange={(e)=>{
                            ...
                            <button 
                            onClick={handleLogin}
                            className="w-[400px] h-[50px] bg-blue-500 text-white rounded-xl mt-[20px] m-[5px] cursor-pointer">
                                
                            {loading ? "Logging in..." : "Login"}
                            </button>

                            <button className="w-[400px] h-[50px] bg-blue-500 text-white rounded-xl m-[5px] cursor-pointer flex items-center justify-center"
